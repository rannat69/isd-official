import HKUSTLands3MillionGPTX02 from '@/assets/news/HKUSTLands3MillionGPTX/HKUSTLands3MillionGPTX2.jpg';
import HKUSTLands3MillionGPTX03 from '@/assets/news/HKUSTLands3MillionGPTX/HKUSTLands3MillionGPTX3.jpg';
...
export default function HKUSTLands3MillionGPTX() {
    return (
        <div className="flex flex-col lg:gap-[24px] gap-[12px] lg:text-md text-sm">
            <p>
                A HK$3 million donation from GPTX Investment Management Limited
                (GPTX簡坤投資) is set to energise student-led innovation and
                entrepreneurial ventures at the Division of Integrative Systems
                and Design (ISD) of The Hong Kong University of Science and
                Technology (HKUST). The contribution from the Hong Kong-based
                digital investment firm signals a shared vision of nurturing
            ...
            <p>
                ...
                Institutional Advancement of HKUST, and{' '}
                <strong>Ms. Ophelia GAO</strong>, CEO of GPTX簡坤投資. The
                ceremony was joined by <strong>Prof. ZHANG Qian</strong>, Head
                of ISD, alongside ISD faculty and student representatives, as
                well as senior leader and distinguished guests of GPTX簡坤投資:{' '}
                <strong>Mr. Ken NG</strong>, Chief Investment Officer,{' '}
                <strong>Mr. MA Wai-Kiu</strong>, Vice President of HK Guangxi
                Community Organisations, <strong>Mr. ZHANG Kun</strong>, Deputy
                General Manager of Fortera Capital, and{' '}
            ...
            <p>
                ...
                entrepreneurship and innovation with courage and creativity. The
            ...
            <p>
                ...
                entrepreneurial drive, and systems thinking, the division offers
                an interdisciplinary and experiential learning environment where
                students can tackle real-world challenges and create positive
                societal impact.
            </p>
