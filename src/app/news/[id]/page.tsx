    ...
    return (
        <div className="container pt-component-gap-sm pb-section-gap min-h-screen flex flex-col items-stretch">
            <div className="flex flex-col gap-component-gap-sm">
                ...
                >
                    <h1 className=" text-h1 text-[28px] leading-[34px] lg:text-[36px]">
                        {item.title}
                    </h1>
                    ...
                    <div className="flex flex-col gap-[24px]">
                        {item.type === 'events' && (
                            <div className="flex flex-col gap-[24px]">
                                <h2 className="text-[28px] lg:text-[36px] leading-9 font-bold text-primary">
                                    Event Info
                                </h2>
                        ...
                        <div className="flex flex-col gap-component-gap text-sm lg:text-md leading-[21px] lg:leading-[24px] text-isd-font-1">
    ...
    return groups.map((g, idx) => {
        ...
        return (
            <div key={idx} className="flex flex-col gap-[24px]">
                {g.heading ? (
                    <h1 className="text-[28px] lg:text-[36px] leading-9 font-bold text-primary ">
                        {g.heading}
                    </h1>
                ) : null}
