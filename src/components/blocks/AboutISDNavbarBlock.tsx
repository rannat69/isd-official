export default function AboutISDNavbarBlock() {
    ...
    return (
        <div className="hidden lg:block  w-full overflow-clip pt-section-gap gap-section-title-gap dot-pattern before:top-[-115px] before:right-0 [--dot-color:var(--isd-secondary-1)]">
