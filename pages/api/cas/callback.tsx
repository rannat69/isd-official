...
export default async function handler(
    ...
    const ticket = Array.isArray(_req.query.ticket) ? _req.query.ticket[0] : _req.query.ticket;
    ...
    try {
        ...
        try {
            ...
            // Access your required data from parsed object
            const success =
            ...
            const username = success[0]['cas:user'];
